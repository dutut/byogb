...
if __name__  == "__main__":
    ...
    parser.add_argument('--memory_size', type=int, default = 200, help='replay buffer size')#三千改为五百。
    parser.add_argument('--no-cuda', action='store_true', default=False, help='Disables CUDA training.')
    parser.add_argument('--fastmode', action='store_true', default=False, help='Validate during training pass.')###默认False
    parser.add_argument('--sparse', action='store_true', default=False, help='GAT with sparse version or not.')
    parser.add_argument('--seed', type=int, default=72, help='Random seed.')
    parser.add_argument('--epochs', type=int, default=500, help='Number of epochs to train.')#500
    ...
    parser.add_argument('--n_heads', type=int, default=4, help='Number of head attentions.')#4
    parser.add_argument('--dropout', type=float, default=0.3, help='Dropout rate (1 - keep probability).')#0.3
    parser.add_argument('--alpha', type=float, default=0.2, help='Alpha for the leaky_relu.')
    parser.add_argument('--patience', type=int, default=10, help='patience')#patience=10 表示，如果验证集上的性能在连续 10 个训练周期中没有显著提升，则停止训练。
    ...
    parser.add_argument('--seed_shuffle', type=int, default=4, help = 'task sequence shuffle')#控制任务或数据的顺序打乱，通常用于增强模型的泛化能力。
